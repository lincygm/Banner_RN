        ...
        return (
            <View style={{flex: 1}}>
                ...
                <TabNavigator hidesTabTouch={true} tabBarStyle={styles.tab}>
                    {this._renderTabItem(HOME_NORMAL, HOME_FOCUS, HOME, <MainScreen text='home'/>)}
                    {this._renderTabItem(CATEGORY_NORMAL, CATEGORY_FOCUS, CATEGORY, <MainScreen text='category'/>)}
                    {this._renderTabItem(FAXIAN_NORMAL, FAXIAN_FOCUS, FAXIAN, <MainScreen text='faxian'/>)}
                    {this._renderTabItem(CART_NORMAL, CART_FOCUS, CART, <MainScreen text='cart'/>)}
                    {this._renderTabItem(PERSONAL_NORMAL, PERSONAL_FOCUS, PERSONAL, <MainScreen text='personal'/>)}
                </TabNavigator>
...
//AppRegistry.registerComponent('roots', () => Roots);
